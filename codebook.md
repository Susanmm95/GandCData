...
Alabels<-factor(merge$Activity, labels=c("Walking","Walking Upstairs", "Walking Downstairs", "Sitting", "Standing", "Laying"))
merge$Activity<-Alabels
...
write.table(tidy_means, file = "TidyMeans.txt", sep = ",", row.names = FALSE)
